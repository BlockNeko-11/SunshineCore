...
abstract class Subscriber<T extends Event> {
    ...
    static int compare(Subscriber<?> a, Subscriber<?> b) {
        return b.priority - a.priority;
    }

    static final class MethodSubscriber<T extends Event> extends Subscriber<T> {
    ...
    static final class ConsumerSubscriber<T extends Event> extends Subscriber<T> {
